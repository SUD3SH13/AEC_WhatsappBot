...
public class Multiple_whatsapp {
    ...
    private static void placeComponents(JPanel panel) {
        ...
        JLabel recipientLabel = new JLabel("Recipient Phone Numbers (Separated by comma):");
        recipientLabel.setBounds(10, 80, 300, 25);
        panel.add(recipientLabel);

        JTextField recipientText = new JTextField(20);
        recipientText.setBounds(10, 110, 350, 25);
        ...
        loginButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String recipientPhoneNumbers = recipientText.getText();

                loginAndSendMessage(numberOfMessages, messageContent, recipientPhoneNumbers);
            }
        });
        panel.add(loginButton);
    }

    private static void loginAndSendMessage(int numberOfMessages, String messageContent, String recipientPhoneNumbers) {
        ...
        for (String recipient : recipients) {
            sendMessage(recipient.trim(), messageContent, numberOfMessages);
        }
    }
